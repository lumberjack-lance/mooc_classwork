 ...
 * {@link LinkListFragment} and the item details
 * (if present) is a {@link LinkDetailFragment}.
 * <p/>
 * This activity also implements the required
 * {@link LinkListFragment.Callbacks} interface
...
public class LinkListActivity extends FragmentActivity
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (findViewById(R.id.link_detail_container) != null) {
            ...
            ((LinkListFragment) getSupportFragmentManager()
                    .findFragmentById(R.id.link_list))
    ...
    /**
     * Callback method from {@link LinkListFragment.Callbacks}
